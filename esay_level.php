<?php
// Mulai sesi untuk pengecekan login dan pengambilan data pengguna
session_start();
...
//Koneksi ke database
include('koneksi.php');  // Gantilah dengan koneksi database Anda

// // Ambil tantangan yang levelnya 'easy' dari database
// $query = "SELECT * FROM challenges WHERE level = 'easy'";
// $result = mysqli_query($conn, $query);

// // Periksa apakah ada tantangan yang ditemukan
...
// // Handle aksi mulai tantangan (misalnya, saat pengguna mengklik tombol "Yuk, Mulai!")
// if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['start_challenge'])) {
//     // Dapatkan ID tantangan yang dipilih
//     $challenge_id = $_POST['challenge_id'];
//     // Lakukan logika seperti menyimpan progress atau memulai tantangan
//     $_SESSION['current_challenge'] = $challenge_id;  // Menyimpan ID tantangan dalam sesi
    
//     // Redirect ke halaman tantangan atau soal berikutnya
...
<body>
  ...
  <div class="main-content">
    ...
    <!-- <?php
        // Loop through the challenges and display them in cards
        foreach ($challenges as $challenge) {
          echo '
          <div class="card">
            <a href="chalange.php?id=' . $challenge['id'] . '">
              <img src="element-icon/game-code.png" alt="' . htmlspecialchars($challenge['name']) . '">
      ...
      <div class="card">
        <a href="chalange.php">
          <img src="element-icon/game-code.png" alt="Icon 1">
        </a>
      </div>
      <div class="card">
