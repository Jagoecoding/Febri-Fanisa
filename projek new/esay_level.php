  ...
  <style>
    ...
    * {
    ...
    .section-title {
      font-size: 18px;
      font-weight: bold;
      margin: 0 auto 20px; /* Centers the element horizontally */
      padding: 10px 15px;
    ...
    .card {
      ...
      border-radius: 30px;
      padding: 30px; /* Removed padding to fit the image perfectly */
      margin: 10px;
      width: calc(30% - 80px); /* Adjust card width to fit three in a row */
      display: flex;
      flex-direction: column;
      align-items: center;
      text-align: center;
