...
<body>
    <div class="verification-container">
        ...
        <p>Please follow the instructions to register your face.</p>

        <!-- A button to trigger the Python script -->
        <!-- Face registration button -->
        <button onclick="window.location.href='run_registration_script.php'">Register Face</button>

        <script>
            function registerFace() {
                // Example of triggering the face registration Python script
                window.location.href = 'run_registration_script.php';
            }
        </script>
    </div>
</body>
